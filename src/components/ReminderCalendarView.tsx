...
const ReminderCalendarView = ({
  ...
  function CustomDay(props: any) {
    ...
    return (
      <button {...rest} type="button" tabIndex={0} className="w-full h-full">
        ...
        <div className="w-full">
          <Calendar
            ...
            classNames={{
              ...
              head_cell: "text-muted-foreground rounded-md w-full font-normal text-[0.9rem] flex-1 text-center",
              row: "flex w-full mt-2",
              cell: "relative text-center text-sm p-0 flex-1 h-12 [&:has([aria-selected])]:bg-accent first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
